...
public class Casino {
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("Where do you want to play? (Blackjack, Roulette, Coinflip)");
			...
			if (answer.toLowerCase().equals("blackjack")) {
				...
				balance = Roulette.play(balance);
				System.out.println("Your Balance: " + balance);}
				else if (answer.toLowerCase().equals("coinflip")) {
					balance = Coinflip.play(balance);
					System.out.println("Your Balance: " + balance);
